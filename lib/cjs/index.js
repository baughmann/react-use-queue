...
exports.default = (function () {
    ...
    var _a = (0, react_1.useReducer)(jobsReducer, []), jobs = _a[0], dispatch = _a[1];
    // whether or not the queue is performing a job
    var _b = (0, react_1.useReducer)(isExecutingTaskReducer, false), isExecutingTask = _b[0], setIsExecutingTask = _b[1];
    // the callback to be executed once all jobs are completed
    var _c = (0, react_1.useState)(), doneCallback = _c[0], setDoneCallback = _c[1];
